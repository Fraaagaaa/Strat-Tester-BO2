...
- `!points`        define a pontuação do jogador, pode ser usado com `inf` para obter pontos infinitos
...
- [MJ](https://github.com/mjmodz) por ajudar com o menu de seleção de perks.
- [Astrox](https://www.twitch.tv/lastroxl) por explicar como funciona o setup no power.